...
```{r}
list_of_files = list.files("C:/Users/rogue/Documents/MLSMML/github_methods_3/experiment_2/")
df = data.frame()

for(i in 1:length(list_of_files)){
temp_df <- read.csv(sprintf("C:/Users/rogue/Documents/MLSMML/github_methods_3/experiment_2/%s",list_of_files[i]))
df = rbind(df,temp_df)}
summary(df)
```
