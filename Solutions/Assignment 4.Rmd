...
```{python}
data = np.load('C:/Users/rogue/OneDrive/Dokumenter/MLSMML/Assignment 3/megmag_data.npy')
y = np.load('C:/Users/rogue/OneDrive/Dokumenter/MLSMML/Assignment 3/pas_vector.npy')
```
