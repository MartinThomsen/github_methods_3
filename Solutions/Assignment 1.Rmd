...
```
Total duration: Some sort of time.
f0mn: Base frequency of the pitch of each participant. 
...
regF1_factor = lm(df.F1$f0mn~df.F1$scenario_factor)
...
```{r}
head(model.matrix(regF1_factor, data = df.F1))
```
...
```{r}
head(model.matrix(regF1_integer, data = df.F1))
```
...
```{r}
politeness$colour[politeness$attitude=="pol"] = "red"
politeness$colour[politeness$attitude=="inf"] = "black"
F1 = filter(politeness, subject == "F1")
F2 = filter(politeness, subject == "F2")
F3 = filter(politeness, subject == "F3")
F4 = filter(politeness, subject == "F4")
F5 = filter(politeness, subject == "F5")
F6 = filter(politeness, subject == "F6")
F7 = filter(politeness, subject == "F7")
F8 = filter(politeness, subject == "F8")
F9 = filter(politeness, subject == "F9")
M1 = filter(politeness, subject == "M1")
M2 = filter(politeness, subject == "M2")
M3 = filter(politeness, subject == "M3")
M4 = filter(politeness, subject == "M4")
M5 = filter(politeness, subject == "M5")
M6 = filter(politeness, subject == "M6")
M7 = filter(politeness, subject == "M7")

par(mfrow=c(3,3))
plot(F1$scenario, F1$f0mn, col=F1$colour, ylim = c(100,300))
plot(F2$scenario, F2$f0mn, col=F1$colour, ylim = c(100,300))
plot(F3$scenario, F3$f0mn, col=F1$colour, ylim = c(100,300))
plot(F4$scenario, F4$f0mn, col=F1$colour, ylim = c(100,300))
plot(F5$scenario, F5$f0mn, col=F1$colour, ylim = c(100,300))
plot(F6$scenario, F6$f0mn, col=F1$colour, ylim = c(100,300))
plot(F7$scenario, F7$f0mn, col=F1$colour, ylim = c(100,300))
plot(F8$scenario, F8$f0mn, col=F1$colour, ylim = c(100,300))
plot(F9$scenario, F9$f0mn, col=F1$colour, ylim = c(100,300))
par(mfrow=c(3,3))
plot(M1$scenario, M1$f0mn, col=F1$colour, ylim = c(50,250))
plot(M2$scenario, M2$f0mn, col=F1$colour, ylim = c(50,250))
plot(M3$scenario, M3$f0mn, col=F1$colour, ylim = c(50,250))
plot(M4$scenario, M4$f0mn, col=F1$colour, ylim = c(50,250))
plot(M5$scenario, M5$f0mn, col=F1$colour, ylim = c(50,250))
plot(M6$scenario, M6$f0mn, col=F1$colour, ylim = c(50,250))
plot(M7$scenario, M7$f0mn, col=F1$colour, ylim = c(50,250))
```
...
```{r}
pitch_On_Gender = lm(f0mn~gender, data = politeness)
```
...
pitch_On_Gender_Scenario = lmer(f0mn~gender + (1|scenario), data = politeness)
```
