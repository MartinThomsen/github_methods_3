...
\NormalTok{model }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(data[,}\DecValTok{1}\NormalTok{]}\SpecialCharTok{\textasciitilde{}}\NormalTok{data[,}\DecValTok{6}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(data[,}\DecValTok{1}\NormalTok{],data[,}\DecValTok{6}\NormalTok{])}
\end{Highlighting}
\end{Shaded}

\includegraphics{Brushing-up-on-the-linear-model_files/figure-latex/unnamed-chunk-3-1.pdf}
